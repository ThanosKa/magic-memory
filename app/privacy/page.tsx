          ...
          <div className="mt-8 space-y-8 text-muted-foreground">
            <section>
              ...
              <p className="mt-2">
                ...
                when you sign in with Google. We also collect photos you upload for restoration.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="mt-2">
                We use your information to provide and improve our services, process payments, communicate with you, and
                ensure the security of our platform.
              </p>
            </section>

            <section>
              <h2 className="text-xl font-semibold text-foreground">3. Photo Storage</h2>
              <p className="mt-2">
                Uploaded and restored photos are stored securely using Supabase Storage. Photos are organized by user ID
                for privacy. You can request deletion of your photos at any time.
              </p>
            </section>
            ...
            <section>
              ...
              <ul className="mt-2 list-disc pl-6 space-y-1">
                ...
                <li>Replicate API for AI photo restoration</li>
              </ul>
            </section>
