...
describe("POST /api/stripe/create-checkout", () => {
    ...
    it("includes correct metadata in checkout session", async () => {
        ...
        Object.defineProperty(CREDIT_PACKAGES.growth, "priceId", { value: "price_growth", writable: true, configurable: true })
        ...
        Object.defineProperty(CREDIT_PACKAGES.growth, "priceId", { value: originalPriceId, writable: true, configurable: true })
    })
})
